...
export default function CourseBatchAddDialog() {
  ...
  const handleSubmit = async (values: CourseBatchInput) => {
    toast.promise(mutateAsync({ courseId, body: values }), {
  ...
  return (
    <EntityDialog
      ...
      title="Tambah Course Batch"
      description="Isi detail batch di bawah ini"
      isPending={isPending}
      saveLabel="Create Course Batch"
      onSubmit={form.handleSubmit(handleSubmit)}
      className="max-w-4xl!"
      trigger={
        <Button size="sm">
          Tambah Batch <PlusCircle className="ml-2 h-4 w-4" />
        </Button>
      }
    >
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field className="md:col-span-2 gap-1" data-invalid={fieldState.invalid}>
                  ...
                  <Input {...field} placeholder="Batch name" />
                    ...
                    <Controller
                      ...
                      render={({ field, fieldState }) => (
                        <Field data-invalid={fieldState.invalid}>
                          ...
                          <Input {...field} placeholder="Session topic" />
                          {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
                        </Field>
                      )}
                    />
